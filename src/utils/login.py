"""
Module: Secure Auth System
Purpose: A professional login interface featuring Regex-based validation
         and dynamic UI feedback using PyQt5.
Architecture: Decoupled validation logic (AuthValidator) from UI (MainWindow).
...
class AuthValidator:
    """
    Static helper class to maintain single responsibility:
    Logic here focuses strictly on data integrity, not UI.
    """
    @staticmethod
...
class MainWindow(QMainWindow):
    ...
    def handle_submit(self):
        ...
        # Guard clauses used for step-by-step validation feedback to the user
        ...
        # Success state: Clear sensitive data and disable button to prevent duplicate submissions
