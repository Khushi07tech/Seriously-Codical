"""
Module: Codical Calculator
Purpose: A custom-built calculator implementing manual expression parsing
         and Order of Operations (multiplication/division before addition/subtraction).
...
class Calculator(QWidget):
    ...
    def init_ui(self):
        ...
        # Connect all digit and operator buttons to the display feeder
        buttons = [self.digit0_button, self.digit1_button, self.digit2_button,
                   self.digit3_button, self.digit4_button, self.digit5_button,
                   self.digit6_button, self.digit7_button, self.digit8_button,
                   self.digit9_button, self.decimal_button, self.oper_divide_button,
                   self.oper_multiply_button, self.oper_subtract_button, self.oper_add_button]

        for btn in buttons:
            btn.clicked.connect(self.send_digits)
    ...
    def styling(self):
        ...
        # Operator button styling for visual distinction
    ...
    def split(self):
        ...
        This manually identifies multi-digit numbers before starting calculations.
        """
    ...
    def calc(self):
        """
        Executes calculations in two passes to respect mathematical precedence.
