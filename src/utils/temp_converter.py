"""
Module: Temperature Converter Pro
Purpose: A PyQt5-based GUI application for multi-unit temperature conversions.
Features: Real-time error handling, CSS-based styling, and precision formatting.
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Using ObjectNames to target specific labels via CSS without affecting global QLabels
    ...
    def get_user_temp(self):
        ...
        if not line_text:
            ...
            return None
        try:
            # Centralized validation to prevent crash if user enters non-numeric characters
    ...
    def c_to_f(self):
        ...
        if text is None: # Guard clause to stop execution if input is invalid
            return
